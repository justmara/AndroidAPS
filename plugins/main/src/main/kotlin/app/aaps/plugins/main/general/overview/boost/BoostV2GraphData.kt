...
class BoostV2GraphData @Inject constructor(
    ...
    fun addSteps(useForScale: Boolean, scale: Double) {
        ...
        // before reading the highest value - otherwise highestValueY returns the value already
        // scaled by the previous render and the axis/scale drifts (garbage step heights).
