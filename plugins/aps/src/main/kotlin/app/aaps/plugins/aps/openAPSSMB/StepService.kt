...
object StepService : SensorEventListener {
    ...
    /** Drop an implausible per-bucket jump (a glitching counter reporting its raw cumulative value). */
    private const val maxPlausibleBucketSteps = 1500
    ...
    override fun onSensorChanged(sensorEvent: SensorEvent?) {
        ...
        if(previousStepCount >= 0) {
            ...
            if (delta in 0..maxPlausibleBucketSteps) {
