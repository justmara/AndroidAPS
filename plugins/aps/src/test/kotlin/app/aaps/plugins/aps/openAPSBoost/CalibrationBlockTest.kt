...
class CalibrationBlockTest : TestBaseWithProfile() {
    ...
    @Mock lateinit var dynamicCarbRatioCalculator: DynamicCarbRatioCalculator
    ...
    @BeforeEach fun prepare() {
        // V6 plugin reads these persisted-state blobs at construction; real prefs return "" (the key
        // default), but a bare mock returns null → deserialize NPEs. Stub them to the empty default.
        ...
        plugin = OpenAPSBoostPlugin(
            ...
            bgQualityCheck, uiInteraction, tddCalculator, dynamicCarbRatioCalculator, determineBasalBoost,
            boostRiskModel, boostMealModel, boostIsfShadow, profiler, apsResultProvider, Provider { boostV5Plugin },
            healthConnectHrIngest, healthConnectStepsIngest
        )
