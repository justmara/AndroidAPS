    ...
    fun prepare() {
        ...
        openAPSSMBPlugin =
            OpenAPSSMBPlugin(
                ...
                uiInteraction, determineBasalSMB, profiler, GlucoseStatusCalculatorSMB(aapsLogger, iobCobCalculator, dateUtil, decimalFormatter, deltaCalculator), apsResultProvider, dynamicCarbRatioCalculator
            )
        openAPSAMAPlugin =
            OpenAPSAMAPlugin(
